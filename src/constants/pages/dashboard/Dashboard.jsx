  ...
  const fetchData = async (isRefresh = false) => {
    ...
    try {
      const [
        ...
        API.get("/api/charts/performance-distribution", { params }),
        API.get("/api/charts/subject-pass-fail", { params }),
        API.get("/api/charts/subject-average", { params }),
        API.get("/api/charts/term-comparison", { params }),
        API.get("/api/charts/report-subject-avg", { params }),
        API.get("/api/charts/report-term-avg", { params }),
        API.get("/api/table/top-students-overall", { params }),
        API.get("/api/table/top-students-subject", { params }),
        API.get("/api/table/leaderboard", { params }),
      ]);
